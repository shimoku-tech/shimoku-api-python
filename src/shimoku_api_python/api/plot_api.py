...
class PlotApi(BasePlot):
    ...
    async def input_form(
        ...
        """
        :param data:
        :param report_dataset_properties:
        :param menu_path:
        :param order:
        :param rows_size:
        :param cols_size:
        ...
        :param tabs_index:
        :param modal_name:
        :param modal_to_open_on_submit:
        :param activity_id_to_call_on_submit:
        :param acivity_name_to_call_on_submit:
        :param on_submit_events:
        """
