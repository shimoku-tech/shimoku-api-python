...
async def line_chart(self: 'PlotApi', *args, x: str, **kwargs):
    """ Create a line chart """
...
@async_auto_call_manager()
@logging_before_and_after(logger.info)
async def area_chart(self: 'PlotApi', *args, x: str, **kwargs):
...
@async_auto_call_manager()
@logging_before_and_after(logger.info)
async def stacked_area_chart(self: 'PlotApi', *args, x: str, **kwargs):
