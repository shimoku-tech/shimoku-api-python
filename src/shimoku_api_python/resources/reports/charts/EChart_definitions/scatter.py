...
async def scatter_chart(self: 'NewPlotApi', order: int, point_fields: Union[List[Tuple[str, str]], Tuple[str, str]],
                        data: Optional[Union[List[str], DataFrame, List[Dict]]] = None,
                        x_axis_name: Optional[str] = None, y_axis_name: Optional[str] = None,
                        title: Optional[str] = None, bottom_toolbox: bool = False,
    ...
    common_options['legend']['padding'][1] = 224
    ...
    await self._create_trend_chart(echart_options=common_options, series_options=series_options,
                                   bottom_toolbox=bottom_toolbox, axes=[], values=point_fields,
